...
public class UserServiceImpl implements UserService {
    ...
    public SettingVO getHabits() {
        ...
        return (SettingVO.builder()
                .shareAggregated(setting.getShareStatistics())
                .nightlyReminder(setting.getRecordRemind())
                .breathingNotification(setting.getExerciseNotice())
                .build());
    }
    ...
    public void setHabits(SettingDTO settingDTO) {
        ...
        setting.setStudentId(BaseContext.getCurrentId());
        setting.setShareStatistics(settingDTO.isShareAggregated());
        setting.setRecordRemind(settingDTO.isNightlyReminder());
        setting.setExerciseNotice(settingDTO.isBreathingNotification());
        userMapper.setHabits(setting);
    }
